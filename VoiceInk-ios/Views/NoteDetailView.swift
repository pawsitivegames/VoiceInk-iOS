                ...
                HStack(alignment: .top, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        HStack {
                            ...
                            Spacer()
                            Button(action: { clipboardService.copy(displayedTranscriptText, message: "\(primaryLanguageLabel) text copied") }) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        HStack {
                            Text(translationLanguageLabel)
                                ...
                                .foregroundStyle(.primary)
                            Spacer()
                            Button(action: { clipboardService.copy(translatedText, message: "\(translationLanguageLabel) text copied") }) {
                                Image(systemName: "doc.on.doc")
                                    .font(.caption)
                                    .foregroundStyle(.blue)
                            }
